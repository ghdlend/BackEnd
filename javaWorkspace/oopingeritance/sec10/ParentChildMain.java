...
public class ParentChildMain {
	...
	public static void main(String[] args) {
		...
		//parent.method3(); //Child 클래스에 있는 method 사용 불가능
		
		//예외적으로 subclass가 superclass의 메소드를 재정의 했으면 subclass의 메소드 호출이 됨
		parent.method2(); //subclass의 메소드가 호출됨
