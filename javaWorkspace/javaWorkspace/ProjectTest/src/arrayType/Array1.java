...
public class Array1 {
	...
	public static void main(String[] args) {
		...
		//배열 변수 a에 저장된 값 출력
		System.out.println(a); //[I@2ff4acd0 - 실제 주소가 아닌 16진수로 구성된 내부 가상주소
		//[I@2ff4acd0 : [ -> 1차원 배열 ,[[ -> 2차원 배열, I -> int, @ -> 16진수 가상주소
		...
		//배열 선언, 할당, 배열 크기 설정과 값 저장 ->값을 초기화하면서 크기를 명시하면 오류
		//int[] score = new int[3] {90,30,40};
		
		//선언 해놓은 b배열 생성하고 값 저장 -> {} : 선언시에만 가능한 문법
		//b = {10,45,70}   오류
		b = new int[3];
		...
		//Arrays 클래스의 toString() a메소드 사용 - 전체 배열 값 출력
